...
HELP_PIC = "https://te.legra.ph/file/11adba95c2c26ae877ccf.jpg"

DEAD_HELP = "🔥 ʙʟᴀᴄᴋ x ʟᴏᴠᴇʀ 🔥\n\n"
...
DEAD_HELP += f"© @Exampur20\n"


@BOT0.on(events.NewMessage(incoming=True, pattern='/help'))
async def help(event):               
    if event.sender_id in SUDOERS:
       blaze = [[Button.url("ᴄʜᴀɴɴᴇʟ", "https://t.me/BlackMusicSupport"), Button.url("sᴜᴘᴘᴏʀᴛ", "https://t.me/Exampur20")]]
